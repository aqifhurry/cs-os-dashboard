    ...
    <PageLayout navbar={<NavbarCS />}>
      ...
      <div className="fq-header">
        <div>
          ...
          <p className="fq-sub">Standard response & script WA siap pakai</p>
        </div>
        <div className="fq-readonly-badge">View Only</div>
      </div>
      ...
      {Object.keys(grouped).length === 0 && (
        <div className="fq-empty">
          <EmptyIcon />
          <p>{search||katFilter ? "Tidak ada hasil." : "Belum ada FAQ dari Supervisor."}</p>
        </div>
      )}
                ...
                <div key={f.id} className={`fq-item ${isOpen?"open":""}`}>
                  ...
                  {isOpen && (
                    <div className="fq-body">
                      ...
                      {/* Script WA — CS bisa langsung copy */}
                      {f.scriptWA && (
                        <div className="fq-section">
                          ...
                          <div className="fq-script-wrap">
                            ...
                            >
                              ...
                              {copied===f.id ? "Tersalin!" : "Copy Script"}
                            </button>
                          </div>
                        </div>
                      )}
...
const css = `
  ...
  .fq-readonly-badge { padding:6px 12px; border-radius:8px; background:#F3F4F6; color:#6B7280; font-size:12px; font-weight:600; font-family:'Plus Jakarta Sans',sans-serif; align-self:flex-start; }
  ...
  .fq-script { background:#F0FFF4; border:1.5px solid #BBF7D0; border-radius:10px; padding:14px 16px; padding-right:120px; font-size:13px; color:#166534; line-height:1.7; white-space:pre-wrap; font-family:'Plus Jakarta Sans',sans-serif; margin:0; }
